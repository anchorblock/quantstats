...
def full(
    ...
    **kwargs,
    ...
    if df is not None:
        ...
        max_lev = max(df['max_leverage'].values)
        ...
        axes[0, 0].plot(df['gross_leverage'])
        axes[0, 1].plot(df['net_leverage'])
        axes[1, 0].plot(df['long_exposure'])
        axes[1, 1].plot(df['short_exposure'])
